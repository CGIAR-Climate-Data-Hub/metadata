...
| version chain (derived) | Encoder output only | Superseded records get `deprecated: true`, `links[rel=successor-version]`, and `links[rel=latest-version]`                              | Same links on superseded records                                                                      |
